...
{
    /// <inheritdoc />
    public partial class greenmobility : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCost = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    RentalCode = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "VehicleStatusId", "Status" },
                values: new object[,]
                {
                    { 1, "Disponibile" },
                    { 2, "In Uso" },
